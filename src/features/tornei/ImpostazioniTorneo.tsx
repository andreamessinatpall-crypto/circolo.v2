...
export default function ImpostazioniTorneo({
  ...
  // (Fase 6bis) Solo americano: Normale o Misto.
  const [modalitaAmericano, setModalitaAmericano] = useState<'normale' | 'misto'>(
    torneo.modalita_americano === 'misto' ? 'misto' : 'normale',
  )
  ...
  function apri() {
    ...
    setModalitaAmericano(torneo.modalita_americano === 'misto' ? 'misto' : 'normale')
  ...
  async function onSubmit(v: FormOut) {
    ...
    const payload: Record<string, unknown> = {
      ...
      modalita_americano: isAmericano ? modalitaAmericano : 'normale',
    }
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-2">
              ...
              {isAmericano ? (
                <div>
                  ...
                  <div className="opzione-grid mb-2">
                    <button
                      type="button"
                  ...
                  {modalitaAmericano === 'misto' && (
                    <p className="sub mb-2" style={{ fontSize: '0.82rem' }}>
                      Le coppie di ogni round saranno sempre uomo-donna. Se cambi modalità dopo aver
                      generato i turni, rigenerali dalla sezione "Turni".
                    </p>
                  )}
